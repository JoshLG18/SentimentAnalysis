...
The dataset was split 80/20 into a training and testing set. All text was converted to lower case and then 
tokenised, words no contained within GloVe where removed to ensure full embedding coverage. A custom vocabulary was then built,
all sequences were padded or truncated to be of the same length.

An embedding matrix was then constructed using pre-trained gloVe embeddings to speed up training time, words not contained in
gloVe were randomly initialised. Processed inputs and labels were formatted as PyTorch tensors and batched.
